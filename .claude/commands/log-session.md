...
Summarise the current conversation session and append the summary to `docs/background/ai_edit_log_full.md`.
...
- If `docs/background/ai_edit_log_full.md` is empty, this is the first entry; otherwise append below the existing entries.
